// Stepper.h
//
/// \mainpage Stepper library for Arduino
///
/// This is the Arduino Stepper library.
...
///
/// Stepper significantly improves on the standard Arduino Stepper library in several ways:
...
/// http://www.airspayce.com/mikem/arduino/Stepper
/// The version of the package that this documentation refers to can be downloaded 
/// from http://www.airspayce.com/mikem/arduino/Stepper/Stepper-1.40.zip
///
/// Example Arduino programs are included to show the main modes of use.
///
/// You can also find online help and discussion at http://groups.google.com/group/Stepper
...
/// with the exception that Stepper uses steps per second rather than radians per second
...
///
/// \htmlonly <form action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_donations" /> <input type="hidden" name="business" value="mikem@airspayce.com" /> <input type="hidden" name="lc" value="AU" /> <input type="hidden" name="item_name" value="Airspayce" /> <input type="hidden" name="item_number" value="Stepper" /> <input type="hidden" name="currency_code" value="USD" /> <input type="hidden" name="bn" value="PP-DonationsBF:btn_donateCC_LG.gif:NonHosted" /> <input type="image" alt="PayPal — The safer, easier way to pay online." name="submit" src="https://www.paypalobjects.com/en_AU/i/btn/btn_donateCC_LG.gif" /> <img alt="" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1" border="0" /></form> \endhtmlonly
/// 
/// \par Trademarks
///
/// Stepper is a trademark of AirSpayce Pty Ltd. The Stepper mark was first used on April 26 2010 for
...
///               specifying Stepper::FULL4WIRE and friends.
...
// $Id: Stepper.h,v 1.19 2013/08/02 01:53:21 mikem Exp mikem $
...
/////////////////////////////////////////////////////////////////////
/// \class Stepper Stepper.h <Stepper.h>
...
/// Stepper will not have a correct 
...
public:
    ...
    /// Use this in the pins argument the Stepper constructor to 
    ...
    /// Stepper::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// Stepper::FULL2WIRE (2) means a 2 wire stepper (2 pins required). 
    /// Stepper::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required). 
    /// Stepper::FULL4WIRE (4) means a 4 wire stepper (4 pins required). 
    /// Stepper::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// Stepper::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to Stepper::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a Stepper::DRIVER (pins==1), 
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a Stepper::DRIVER (pins==1), 
...
/// Shows how to run Stepper in the simplest,
...
/// Shows how to use Stepper to control a 3-phase motor, such as a HDD spindle motor
